...
## Begining of functions that can be altered(within 10 lines) 
## to get evidence probability
...
def conditional_probability(x_group, parent_vars, all_evidence, parent_evidence, children_TorF_tuple):
    ...
    alpha = enumerate_all(bn.variables,parent_evidence,bn)
    ...
    if '|' not in content:  # joint/ marginal distribution
        ...
        if ',' in children:
            ...
            if '=' in children:
                ...
                x_group = [child]
        prob_enumeration, prob_elimination, alpha = conditional_probability(x_group, parent_vars, all_evidence, parent_evidence, children_TorF_tuple)
