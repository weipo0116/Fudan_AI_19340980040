...
class BlackjackMDP(util.MDP):
    ...
    def succAndProbReward(self, state, action):
        ...
        if card[2] == None or sum(card[2]) == 0:
            return []
        card_list = list(card)
        possibleStates = []
        ...
        if action == 'Peek':
            ...
            for i in range(len(card_list)):
                if card_list[i] > 0:
                    ...
                    possibleStates.append(((total_value, i, tuple(card_list)), prob, -self.peekCost))
            ...
            if next_index:
                ...
                for i in range(0, len(card_list)):
                    ...
                    if card_list[i] > 0:
                        ...
                        if total_value > self.threshold:
                            possibleStates.append(((total_value, None, None), prob, 0))
                        elif sum(card_list) == 0:
                            possibleStates.append(((total_value, None, None), prob, total_value))
                        else:
                            possibleStates.append(((total_value, None, tuple(card_list)), prob, 0))
...
def peekingMDP():
    ...
    return BlackjackMDP(cardValues=[1, 2, 3, 4, 5, 100],
                        multiplicity=1, threshold=20, peekCost=1)
    # raise Exception("Not implemented yet")
    # END_YOUR_CODE
